...
// (disalin dari fail asal kehadiran murid)
// =========================
...
const classData = {
  ...
  "4G": [
    ...
    "NUR ZARA DAMIA BINTI MOHAMAD AZHAR",
  ...
  "5B": [
    ...
    "NUR ARISYA DAMIA BINTI MOHAMAD SYAFWAN",
  ...
  "6B": [
    ...
    "MOHAMMAD AFIF DANISH BIN MOHAMAD HAFIZ",
...
// (boleh guna jika perlu untuk paparan lain)
// =========================
...
// =========================
// Fungsi untuk app Rekod Pemantauan
// =========================

// Simpan rekod pemantauan ke Firebase
function saveRecordToFirebase(record) {
  return db.ref("rekod_pemantauan").push(record);
}

// Subscribe rekod mengikut tarikh (untuk tab Semak Rekod)
...
// Struktur: kehadiran/{YYYY-MM-DD}/{KELAS} → {present, total, ...}
